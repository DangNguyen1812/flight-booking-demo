...
<html>
    ...
    <body>
                                            ...
                                            <div class="col-md-6">
                                                <fieldset>
                                                    ...
                                                    <select required name="departure" onchange='this.form.()' >
                                                        <option value="" class="city-color">Select a location...</option>
                                                        <c:forEach items="${cities}" var="city">
                                                            <option value="${city.id}" class="city-color">${city.name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </fieldset>
                                            </div>
        ...
        <script>
            document.getElementById("oneway").onclick = function() {myFunction()};
            function myFunction() {
            document.getElementById("return").value = "";
            document.getElementById("return").disabled = true;
            }
            document.getElementById("round").onclick = function() {myFunction1()};
