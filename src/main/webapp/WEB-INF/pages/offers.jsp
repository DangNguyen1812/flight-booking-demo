<%-- 
    Document   : offers
    Created on : Oct 30, 2021, 2:12:44 PM
    Author     : ADMIN
--%>
                ...
                <div class="wrapper pad1">
                        ...
                        <div class="box1">
                            ...
                            <div class="pad"> <strong>Birmingham</strong><br>
                                <ul class="pad_bot1 list1">
                                    <li> <span class="right color1">from GBP 143.-</span> <a href="f book2.html">Zurich</a> </li>
                                </ul>
                    ...
                    <article class="col2">
                        ...
                        <div class="wrapper pad_bot3">
                            <figure class="left marg_right1"><img src="<c:url value="/resources/images/page2_img1.jpg"/>" alt=""></figure>
                            <div class="cols">
                                <h4>From UK</h4>
                                <ul class="list1">
                        ...
                        <div class="wrapper pad_bot3">
                            <figure class="left marg_right1"><img src="<c:url value="/resources/images/page2_img2.jpg"/>" alt=""></figure>
                            <div class="cols">
                        ...
                        <div class="wrapper">
                            <figure class="left marg_right1"><img src="<c:url value="/resources/images/page2_img3.jpg"/>" alt=""></figure>
                            <div class="cols">
                                <h4>From UK</h4>
                                <ul class="list1 pad_bot1">
